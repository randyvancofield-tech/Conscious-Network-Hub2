  ...
  return (
    <div className="min-h-[100dvh] overflow-y-auto bg-[#100f0a] p-4 text-white sm:p-6 lg:p-8">
      <div className="mx-auto max-w-6xl">
        ...
        {applicant && <div className="mb-6"><Mailbox preview={adminPreview} /></div>}
            ...
            <section className="space-y-5">
              ...
              <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
                ...
                <p className="text-sm leading-6 text-slate-300">
                  Applicants can view their application and correspond with HCN Administration. Dashboard,
                  CRM, client, collaboration, calendar, revenue, course, and provider

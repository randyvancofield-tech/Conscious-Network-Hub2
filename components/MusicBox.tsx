...
const MusicBox: React.FC = () => {
  ...
  return (
    <div
      className="fixed inset-x-3 z-[90] pointer-events-none transition-all sm:left-auto sm:right-5 lg:right-6"
      style={{ bottom: 'calc(env(safe-area-inset-bottom, 0px) + 1rem)' }}
      aria-label="Conscious Music playlist player"
    >
      ...
      <div className={`music-box-glow pointer-events-auto ml-auto glass-panel border-2 border-cyan-400/40 backdrop-blur-3xl overflow-hidden flex flex-col transition-all duration-300 bg-gradient-to-br from-blue-950/70 via-slate-900/60 to-blue-900/50 ${isMinimized ? 'w-fit max-w-full rounded-full' : 'w-full sm:w-[min(calc(100vw-1.5rem),24rem)] rounded-[1.5rem] max-h-[calc(100dvh-2rem)]'}`}>
        {!isMinimized && (
        ...
        {isMinimized ? (
          ...
          <button
            ...
            aria-label="Open Conscious Music playlist"
          ...
          <div className="p-5 space-y-4 bg-gradient-to-b from-transparent via-blue-900/20 to-transparent max-h-[90vh] overflow-y-auto custom-scrollbar scrollable">
            ...
            <button
              ...
              aria-label={showPlaylist ? "Hide music playlist" : "Open music playlist"}
            >

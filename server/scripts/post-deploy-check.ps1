...
# Deployment checks must never create persistent test accounts.
# SkipAuthFlow remains accepted for compatibility with existing callers.
Write-Host "Account creation is disabled in deployment checks. Use isolated auth lifecycle tests."
